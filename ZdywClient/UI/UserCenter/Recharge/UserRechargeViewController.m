...
- (void)viewDidLoad
{
    ...
    [_chargeListTable setScrollEnabled:NO];
...
- (void)showMoreRecharge{
    ...
    _chargeListTable.frame = CGRectMake(_chargeListTable.frame.origin.x, _chargeListTable.frame.origin.y, _chargeListTable.frame.size.width, [_rechargeList count]*54);
...
- (BOOL)gestureRecognizer:(UIGestureRecognizer *)gestureRecognizer shouldReceiveTouch:(UITouch *)touch{
    ...
    if (CGRectContainsPoint(_chargeListTable.frame, point)) {
        return NO;
    }
