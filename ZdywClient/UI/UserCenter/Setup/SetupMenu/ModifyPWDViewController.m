...
- (void) viewDidLoad 
{
    ...
    [_modifyPwdBtn setBackgroundImage:[UIImage createImageWithColor:[UIColor colorWithRed:25.0/255 green:151.0/255 blue:216.0/255 alpha:1.0]] forState:UIControlStateNormal];
...
- (IBAction)clickModify:(id)sender;
{
    ...
    //获取老密码
    strOldPwd = [Zdyw_rc4 RC4Encrypt:strOldPwd withKey:kZdywPublicKey];
    //获取新mim
