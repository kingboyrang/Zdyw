...
- (void)viewDidLoad
{
    ...
    _seachBarBgView.image = [[[UIImage imageNamed:@"contact_searchtext_bg.png"] stretchableImageWithLeftCapWidth:35 topCapHeight:30] ZdywScaleToSize:CGSizeMake(600, 62)];
