...
- (void)addTipView{
    ...
    tipViewBg.image = [[[UIImage imageNamed:@"menu_guide_bg.png"] stretchableImageWithLeftCapWidth:10 topCapHeight:165] ZdywScaleToSize:CGSizeMake(tipView.frame.size.width*2, tipView.frame.size.height*2)];
...
- (void)initMainView{
    ...
    if (kZdywClientIsIphone5) {
        _callListView = [[CallListView alloc] initWithFrame:CGRectMake(0, 64, 320, self.mianScrollView.frame.size.height-64)];
    } else {
        _callListView = [[CallListView alloc] initWithFrame:CGRectMake(0, 64, 320, 480 - self.mianScrollView.frame.origin.y-64)];
    }
