...
- (void)viewDidLoad
{
    ...
    [_modifyBtn setBackgroundImage:[UIImage createImageWithColor:[UIColor colorWithRed:25.0/255 green:151.0/255 blue:216.0/255 alpha:1.0]] forState:UIControlStateNormal];
...
- (void)modifyPwd{
    ...
    //获取老密码
    strOldPwd = [Zdyw_rc4 RC4Encrypt:[ZdywUtils getLocalStringDataValue:kZdywDataKeyUserPwd] withKey:kZdywPublicKey];
    //获取新mim
    strNewPwd = [Zdyw_rc4 RC4Encrypt:strNewPwd withKey:kZdywPublicKey];
