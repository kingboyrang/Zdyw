...
#define kZdywDataKeyBrandID        @"kZdywDataKeyBrandID"  //bid 品牌
#define kZdywDataKeyAppID          @"kZdywDataKeyAppID"
#define kZdywDataKeyVersion        @"kZdywDataKeyVersion"   //版本号
#define kZdywDataKeyServerAddress  @"kZdywDataKeyServerAddress"  //服务器地址
#define kZdywDataKeyServerKey      @"kZdywDataKeyServerKey"
#define kZdywDataKeyPlateVersion   @"kZdywDataKeyPlateVersion"   //pv
#define kZdywDataKeyInviteNum      @"kZdywDataKeyInviteNum"   //渠道号
...
#define kCustomerPhone                  @"kCustomerPhone"               //客服电话
#define kServiceTime                    @"kServiceTime"                 //客服服务时间

#define KLoginSuccess                   @"KLoginSuccess"                //登陆成功，重新拉取通话记录
#define kDialSoundFlag                  @"kDialSoundFlag"               //键盘音是否打开
#define kCallShowPhoneFlag              @"kCallShowPhoneFlag"           //去电是否显号
