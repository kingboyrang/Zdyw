...
- (void)commonInit{
    ...
    UIImage *backgroundImage = [[[UIImage imageNamed:@"menu_bg"] stretchableImageWithLeftCapWidth:7  topCapHeight:25] ZdywScaleToSize:CGSizeMake(self.frame.size.width*2, self.frame.size.height*2)];
