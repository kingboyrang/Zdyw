...
- (void)InitMainView{
    ...
    UIView *bottomView = [[UIView alloc] initWithFrame:CGRectMake(0, self.frame.size.height-75, 320, 75)];
    ...
    [bottomView addSubview:unFlodBtn];
    ...
    [bottomView addSubview:unFlodImageView];
    ...
    [bottomView addSubview:unFlodLable];
    ...
    _callListTableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, self.frame.size.width, self.frame.size.height - bottomView.frame.size.height)];
