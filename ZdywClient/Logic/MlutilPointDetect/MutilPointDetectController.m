...
- (void)buildMutilPointDataModel
{
    ...
    if([strBrandId isEqualToString:kZdywBrandID])
    {
        NSMutableArray *hosts=[NSMutableArray arrayWithArray:kZdywServiceHosts];
        if (![kZdywServiceHosts containsObject:kZdywHttpServer]) {
            [hosts addObject:kZdywHttpServer];
        }
