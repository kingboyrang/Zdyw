...
typedef enum
{
    ...
    ZdywServiceUCSTokenType,                        //云之讯连接token
}ZdywServiceType;
...
#define  kNotificationBindNewPhoneFinish            @"kNotificationBindNewPhoneFinish"     //确定改绑手机
...
#define  kNotificationUCSTokenFinish                @"kNotificationUCSTokenFinish"     //云之讯接入token获取
#define  kNotificationUCSTokenFinished                @"kNotificationUCSTokenFinished"     //云之讯接入token已取到